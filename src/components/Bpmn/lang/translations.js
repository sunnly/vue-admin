export default {
  ...
  'This maps to the process definition key.': '这映射到流程定义的键。',
  'Specify more than one group as a comma separated list.': '多个组使用逗号分割。',
  'Specify more than one user as a comma separated list.': '多个用户组使用逗号分割。',
